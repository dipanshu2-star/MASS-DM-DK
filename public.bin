...
BOT_OWNER_ROLE="TH RUNNER" # change what you need 

@bot.event
async def on_ready():
	while True:
		await bot.change_presence(activity=discord.Activity(type=1,name="꧁༒☬A̴t̴a̴n̴u̴A̴D☬༒꧂"))
		await asyncio.sleep(5)
		
		await bot.change_presence(activity=discord.Activity(type=2,name="type $help"))
		await asyncio.sleep(5)
...
async def start(ctx,game:str):
	...
	if BOT_OWNER_ROLE in [role.name for role in author.roles]:
		...
		embed.set_footer(text=f"@꧁༒𝐻𝑎𝑐𝑘ｯ།༒꧂#7513", \
...
async def end(ctx,game:str):
	...
	if BOT_OWNER_ROLE in [role.name for role in author.roles]:
		...
		embed.set_thumbnail(url=url)
		embed.set_image(url="https://cdn.discordapp.com/attachments/539066238870224903/606135147913543693/Tw_1-1-1.gif")
		embed.set_footer(text="@꧁༒𝐻𝑎𝑐𝑘ｯ།༒꧂#7513",icon_url="https://cdn.discordapp.com/attachments/621954596402888724/629760302736736296/JPEG_20190609_075619.jpg")
		embed.timestamp = datetime.datetime.utcnow()
...
async def invite(ctx):
	await ctx.send("**__@everyone Add Me to Your servers!__**\nhttps://discordapp.com/oauth2/authorize?client_id=628255353384992768&permissions=8&scope=bot")
...
async def purge(ctx,amount=1000):
    if 'fetch' in [i.name for i in ctx.message.author.roles]:
...
async def hq(ctx,accuracy:str,prize_won:str,last_question_status:str,result:str):
	...
	if BOT_OWNER_ROLE in [role.name for role in author.roles]:
		embed=discord.Embed(title="Game Results",description=f"**{ctx.guild.name}**",color=0x142c9c)
		embed.add_field(name="HQ",value=f"**Accuracy: {accuracy}{check}\nPrize Won: {prize_won} :moneybag:\nLast Question status: {last_question_status}{check}\nGame Status: {result} {emoji}**")
...
async def trivaa(ctx,accuracy:str,prize_won:str,last_question_status:str,result:str):
	...
	if BOT_OWNER_ROLE in [role.name for role in author.roles]:
		embed=discord.Embed(title="Game Results",description=f"**{ctx.guild.name}**",color=0x142c9c)
		embed.add_field(name="Trivva",value=f"**Accuracy: {accuracy}{check}\nPrize Won: {prize_won} :moneybag:\nLast Question status: {last_question_status}{check}\nGame Status: {result} {emoji}**")
...
async def jeetoh(ctx,accuracy:str,prize_won:str,last_question_status:str,result:str):
	...
	if BOT_OWNER_ROLE in [role.name for role in author.roles]:
		...
		embed.set_image(url="https://cdn.discordapp.com/attachments/539066238870224903/606135147913543693/Tw_1-1-1.gif")
		embed.set_fr(text="@꧁༒𝐻𝑎𝑐𝑘ｯ།༒꧂#7513",icon_url="https://cdn.discordapp.com/attachments/621954596402888724/629760302736736296/JPEG_20190609_075619.jpg")
		embed.timestamp = datetime.datetime.utcnow()
		await ctx.send(content="@everyone",embed=embed)
	else:
...
async def swagiq(ctx,accuracy:str,prize_won:str,last_question_status:str,result:str):
	...
	if BOT_OWNER_ROLE in [role.name for role in author.roles]:
		...
		embed.set_image(url="https://cdn.discordapp.com/attachments/539066238870224903/606135147913543693/Tw_1-1-1.gif")
		embed.set_footer(text="@꧁༒☬A̴t̴a̴n̴u̴A̴D☬༒꧂#2609",icon_url="https://cdn.discordapp.com/attachments/621954596402888724/629760302736736296/JPEG_20190609_075619.jpg")
		embed.timestamp = datetime.datetime.utcnow()
		await ctx.send(content="@everyone ",embed=embed)
	else:
		await ctx.send("**Lol You Not Have Permission To use this commands**:joy: "+ctx.author.mention)
...
async def suggest(ctx):
	...
	embed.add_field(name="**Role Name**", value=f"**Permission role required `{BOT_OWNER_ROLE}`\nMake a `{BOT_OWNER_ROLE}` name role and use this bot**")
	embed.set_footer(text="Made By @꧁༒☬A̴t̴a̴n̴u̴A̴D☬༒꧂#2609")
	embed.timestamp = datetime.datetime.utcnow()
	await ctx.send(embed=embed)
...
async def s(ctx,*,msg):
	...
	for member in ctx.guild.members:
		try:
			...
			embed=discord.Embed(title="꧁༒☬A̴t̴a̴n̴u̴A̴D☬༒꧂ DM",description=f"DM sent to {member.name}#{member.discriminator} \n:white_check_mark:",colour=0x142c9c)
			embed.set_image(url="https://cdn.discordapp.com/attachments/621954596402888724/632300590965325835/fhVTAyV_1.gif")
			embed.set_footer(text="Made By @꧁༒☬A̴t̴a̴n̴u̴A̴D☬༒꧂#2609",icon_url="https://cdn.discordapp.com/attachments/621954596402888724/629760302736736296/JPEG_20190609_075619.jpg")
			await ctx.send(embed=embed)
		except:
			embed=discord.Embed(title='''꧁༒☬A̴t̴a̴n̴u̴A̴D☬༒꧂ DM''',description=f'''DM can't sent to {member.name}#{member.discriminator}''' ''' :x: ''',colour=0x142c9c)
			embed.set_image(url="https://cdn.discordapp.com/attachments/621954596402888724/632300590965325835/fhVTAyV_1.gif")
			embed.set_footer(text="Made By @꧁༒☬A̴t̴a̴n̴u̴A̴D☬༒꧂#2609",icon_url="https://cdn.discordapp.com/attachments/621954596402888724/629760302736736296/JPEG_20190609_075619.jpg")
			await ctx.send(embed=embed)
